<div role="tablist" class="tabs tabs-lifted">
    ...
    <input type="radio" name="administration" role="tab" class="tab" aria-label="{{__('general.semesters')}}" value="semesters" wire:model.live="selectedTab"/>
    ...
    <input type="radio" name="administration" role="tab" class="tab" aria-label="{{__('general.subjects')}}" value="subjects" wire:model.live="selectedTab"/>
    <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
