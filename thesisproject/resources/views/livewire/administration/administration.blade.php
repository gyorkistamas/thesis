<div role="tablist" class="tabs tabs-lifted">
    ...
    <input type="radio" name="administration" role="tab" class="tab" aria-label="{{__('general.places')}}"
           value="places" wire:model.live="selectedTab"/>
    <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
        <div class="fixed inset-0 flex items-center justify-center" style="pointer-events: none;">
            <span class="loading loading-dots loading-lg" wire:loading></span>
        </div>
        @if($selectedTab == 'places')
            <livewire:administration.places-list wire:key="place"/>
        @endif
    </div>
