...
describe('Testing places', () => {
    ...
    it('Creates a class for the course', () => {
        cy.login({ neptun: 'ADMIN0'});
        cy.visit('/');
        cy.get('body > div.backdrop-blur-\\[1\\.5px\\].min-h-screen > div.drawer > div.drawer-content.flex.flex-col > div > div.flex-none.lg\\:hidden > label').click();
        cy.get('body > div.backdrop-blur-\\[1\\.5px\\].min-h-screen > div.drawer > div.drawer-side.z-\\[9999\\] > ul > li:nth-child(3) > a').click();
    ...
    it('Fails to create a class that overlaps with another', () => {
        cy.login({ neptun: 'ADMIN0'});
        cy.visit('/');
        cy.get('body > div.backdrop-blur-\\[1\\.5px\\].min-h-screen > div.drawer > div.drawer-content.flex.flex-col > div > div.flex-none.lg\\:hidden > label').click();
        cy.get('body > div.backdrop-blur-\\[1\\.5px\\].min-h-screen > div.drawer > div.drawer-side.z-\\[9999\\] > ul > li:nth-child(3) > a').click();
        ...
        cy.get('body > div.backdrop-blur-\\[1\\.5px\\].min-h-screen > div.mx-3 > div > div > div:nth-child(6) > div:nth-child(2) > div.mt-4 > div:nth-child(1) > div > div.collapse-content.overflow-visible > div.mt-5 > div:nth-child(2) > table > tbody > tr:nth-child(1) > td:nth-child(4) > div > label').click();
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > input:nth-child(3)').click();
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > div:nth-child(4) > table > tbody > tr:nth-child(2) > td:nth-child(1) > input').type('2024-03-10T10:00:00');
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > div:nth-child(4) > table > tbody > tr:nth-child(2) > td:nth-child(2) > input').type('2024-03-10T12:00:00');
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > div:nth-child(4) > table > tbody > tr:nth-child(2) > td:nth-child(3) > div > div > input').type('t');
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > div:nth-child(4) > table > tbody > tr:nth-child(2) > td:nth-child(3) > div > div > div > div > div > div > a').click();
        cy.wait(5000);
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > div:nth-child(4) > table > tbody > tr:nth-child(2) > td:nth-child(4) > button').click();
        cy.contains('Hiba');
    });

    it('Fails to create a class that is outside semester', () => {
        cy.login({ neptun: 'ADMIN0'});
        cy.visit('/');
        cy.get('body > div.backdrop-blur-\\[1\\.5px\\].min-h-screen > div.drawer > div.drawer-content.flex.flex-col > div > div.flex-none.lg\\:hidden > label').click();
        cy.get('body > div.backdrop-blur-\\[1\\.5px\\].min-h-screen > div.drawer > div.drawer-side.z-\\[9999\\] > ul > li:nth-child(3) > a').click();
        ...
        cy.get('body > div.backdrop-blur-\\[1\\.5px\\].min-h-screen > div.mx-3 > div > div > div:nth-child(6) > div:nth-child(2) > div.mt-4 > div:nth-child(1) > div > div.collapse-content.overflow-visible > div.mt-5 > div:nth-child(2) > table > tbody > tr:nth-child(1) > td:nth-child(4) > div > label').click();
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > input:nth-child(3)').click();
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > div:nth-child(4) > table > tbody > tr:nth-child(2) > td:nth-child(1) > input').type('2022-03-10T10:00:00');
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > div:nth-child(4) > table > tbody > tr:nth-child(2) > td:nth-child(2) > input').type('2022-03-10T12:00:00');
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > div:nth-child(4) > table > tbody > tr:nth-child(2) > td:nth-child(3) > div > div > input').type('t');
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > div:nth-child(4) > table > tbody > tr:nth-child(2) > td:nth-child(3) > div > div > div > div > div > div > a').click();
        cy.wait(5000);
        cy.get('body > div:nth-child(4) > div > div > div.tabs.tabs-lifted > div:nth-child(4) > table > tbody > tr:nth-child(2) > td:nth-child(4) > button').click();
        cy.contains('A mező értékének');
    });
